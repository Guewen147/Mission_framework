...
<body>
    ...
    <div id='import2'>
        <!-- Import du CSV pour modifier directement grâce à un fichier CSV les prix -->
        <form enctype="multipart/form-data" action="<?= base_url('Home/importCompa') ?>" method="post">

            <h4>Comparer un fichier CSV "Incomplet"</h4>
            </br>
            <input type="file" name="files" accept=".csv">
            </br>

            <input type="submit" name="importCompa" value="Import">
        </form>
    </div>
