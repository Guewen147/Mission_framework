    ...
    <div class="container">
        <ul class="responsive-table">
            <li class="table-header">
                ...
                <div class="col col-2">Reference de la Commande</div>
            ...
            <form method="post" action="<?php echo base_url('Home/edit_validation'); ?>?id_order=<?php echo $_GET['id_order']; ?>">
                ...
                ?>
                        ...
                        <li class="table-row">
                            ...
                            <div class="col col-2" data-label="ref"><?php echo $order->reference; ?></div>
                            <form action="" method="POST">
                                <div class="col col-3" data-label="price"><input type="text" name="total_price_tax_incl" id="" value="<?php echo $order->total_price_tax_incl; ?> " required>
                                    <?php
                                    if ($validation->getError('total_price_tax_incl')) {

                                        echo "
                            <div class='attention alert-danger mt-2'>
