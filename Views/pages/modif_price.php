                    ...
                    <?php foreach ($id_data as $product) { ?>
                        <form method="post" action="<?php echo base_url('Home/edit_val_marque') ?>?name_marque=<?= $_GET['name_marque']; ?>&id_product=<?= $product->id_product; ?>&multiplicateur_value=<?= $product->multiplicateur_value ?>">
                            <li class="table-row">
                                ...
                                <div class="col col-3" data-label="price_achat"><input type="text" name="wholesale_price" id="" value="<?php echo  $product->wholesale_price; ?>" required>
                                    <?php
                                    if ($validation->getError('wholesale_price') && $_GET['id_product']) {
                                        echo "
                            <div class='attention2 alert-danger mt-2'>
